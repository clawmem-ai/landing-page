...
const translations = {
  en: {
    ...
    "nav.blog": "Blog",
    // Hero
    "hero.sub": "Shared memory for AI agents.",
    "hero.desc": "ClawMem gives OpenClaw, Claude Code, Codex, and Hermes a shared memory layer that persists across sessions, survives agent handoffs, keeps team context in sync, and stays inspectable, editable, and yours.",
    "hero.hint": "Choose your agent and copy the quick start.",
    "hero.hint.action": "Choose your agent",
    "hero.paste": "quick start by agent",
    // How it works
    ...
    // Team memory spotlight
    "teamMemory.kicker": "Team memory",
    "teamMemory.heading": 'One <span class="claw-accent">shared memory layer</span> for the whole team',
    "teamMemory.desc": "Updates captured by one teammate become usable by the next agent immediately.",
    "teamMemory.stat1": "1 shared memory layer",
    "teamMemory.stat2": "cross-agent handoffs",
    "teamMemory.stat3": "no re-briefing",
    "teamMemory.lane1.name": "Sarah · Claude Code",
    "teamMemory.lane1.note": "client update saved",
    "teamMemory.lane2.name": "Hazel · Codex",
    "teamMemory.lane2.note": "context recalled before work starts",
    "teamMemory.core.title": "Shared team memory",
    "teamMemory.core.item1": "meeting moved → Thu 2pm",
    "teamMemory.core.item2": "proposal focus → sustainability",
    "teamMemory.core.item3": "source → Sarah",
    "teamMemory.recall.label": "next run",
    "teamMemory.recall.title": "Team context is already there",
    "teamMemory.recall.desc": "No Slack archaeology. No repeating the brief.",
    // Inspectable
    ...
    "compare.row6.label": "Team memory",
    "compare.row6.without": "Knowledge stays trapped in separate chats",
    "compare.row6.with": "Teammates and agents build on the same shared memory layer",
    // CTA
    "cta.title": 'Start with the agent you already <span class="claw-accent">use</span>.',
    "cta.desc": "Copy the quick start for the agent you already use.",
    "cta.paste": "agent setup guides",
    "cta.note": "Each tab gives you a copyable quick start for that agent.",
    "cta.console": 'Already installed? <a href="https://console.clawmem.ai/" target="_blank" rel="noreferrer">Go to Console</a> to inspect your shared memory.',
    ...
    "footer.tagline": "Shared memory for OpenClaw, Claude Code, Codex, and Hermes.",
  ...
  "zh-CN": {
    ...
    "hero.desc": "ClawMem \u4e3a OpenClaw\u3001Claude Code\u3001Codex \u548c Hermes \u63d0\u4f9b\u5171\u4eab\u8bb0\u5fc6\u5c42\uff0c\u8ba9\u4e0a\u4e0b\u6587\u80fd\u5728\u4f1a\u8bdd\u3001\u667a\u80fd\u4f53\u4ea4\u63a5\u3001\u56e2\u961f\u534f\u540c\u4e2d\u6301\u7eed\u4fdd\u6301\u540c\u6b65\uff0c\u800c\u4e14\u4ecd\u7136\u53ef\u89c1\u3001\u53ef\u7f16\u8f91\u3001\u7531\u4f60\u638c\u63a7\u3002",
    "hero.hint": "\u9009\u62e9 agent \u5e76\u590d\u5236\u5bf9\u5e94\u7684\u5feb\u901f\u542f\u52a8\u6307\u4ee4\u3002",
    "hero.hint.action": "\u9009\u62e9 agent",
    "hero.paste": "\u6309 agent \u5206\u7ec4\u7684 quick start",
    ...
    // Team memory spotlight
    "teamMemory.kicker": "团队记忆",
    "teamMemory.heading": '整个团队共用的<span class="claw-accent">共享记忆层</span>',
    "teamMemory.desc": "一个队友记录的更新，下一位 agent 立刻就能用上。",
    "teamMemory.stat1": "1 层共享记忆",
    "teamMemory.stat2": "跨 agent handoff",
    "teamMemory.stat3": "无需重复 briefing",
    "teamMemory.lane1.name": "Sarah · Claude Code",
    "teamMemory.lane1.note": "客户更新已写入",
    "teamMemory.lane2.name": "Hazel · Codex",
    "teamMemory.lane2.note": "开始工作前已自动召回",
    "teamMemory.core.title": "团队共享记忆",
    "teamMemory.core.item1": "会议改到 → 周四 2pm",
    "teamMemory.core.item2": "方案重点 → sustainability",
    "teamMemory.core.item3": "来源 → Sarah",
    "teamMemory.recall.label": "next run",
    "teamMemory.recall.title": "团队上下文已经在那儿了",
    "teamMemory.recall.desc": "不用翻 Slack，也不用重复讲背景。",
    ...
    "compare.row6.label": "\u56e2\u961f\u8bb0\u5fc6",
    "compare.row6.without": "\u77e5\u8bc6\u88ab\u56f0\u5728\u5404\u81ea\u7684\u804a\u5929\u91cc",
    "compare.row6.with": "\u961f\u53cb\u548c agents \u53ef\u4ee5\u5728\u540c\u4e00\u5c42\u5171\u4eab\u8bb0\u5fc6\u4e0a\u534f\u540c\u79ef\u7d2f",
    "cta.title": '\u544a\u522b<span class="claw-accent">\u4ece\u96f6\u5f00\u59cb</span>\u3002',
    "cta.desc": "\u590d\u5236\u4f60\u5df2\u5728\u4f7f\u7528\u7684 agent \u5feb\u901f\u542f\u52a8\u6307\u4ee4\u3002",
    "cta.paste": "agent \u5b89\u88c5\u6307\u5357",
    "cta.note": "\u6bcf\u4e2a tab \u90fd\u63d0\u4f9b\u4e00\u6761\u53ef\u76f4\u63a5\u590d\u5236\u7684 quick start\u3002",
    ...
    "footer.install": "\u5b89\u88c5",
    "footer.features": "\u529f\u80fd",
    "footer.tagline": "OpenClaw\u3001Claude Code\u3001Codex \u548c Hermes \u5171\u4eab\u7684\u8bb0\u5fc6\u5c42\u3002",
  ...
  ja: {
    ...
    "nav.blog": "\u30d6\u30ed\u30b0",
    "hero.sub": "\u672c\u5f53\u306b\u6b8b\u308b\u8a18\u61b6\u3002",
    "hero.desc": "ClawMem \u306f OpenClaw\u3001Claude Code\u3001Codex\u3001Hermes \u306b\u5171\u6709\u30e1\u30e2\u30ea\u30ec\u30a4\u30e4\u30fc\u3092\u63d0\u4f9b\u3057\u3001\u30bb\u30c3\u30b7\u30e7\u30f3\u3092\u307e\u305f\u3044\u3067\u7d99\u7d9a\u3057\u3001agent \u9593\u306e handoff \u3067\u3082\u3001\u30c1\u30fc\u30e0\u3067\u3082\u6587\u8108\u3092\u540c\u671f\u3067\u304d\u307e\u3059\u3002\u3057\u304b\u3082\u3001\u3059\u3079\u3066\u95b2\u89a7\u30fb\u7de8\u96c6\u53ef\u80fd\u3067\u3001\u3042\u306a\u305f\u306e\u3082\u306e\u3067\u3059\u3002",
    "hero.hint": "agent \u3092\u9078\u3093\u3067\u3001\u5bfe\u5fdc\u3059\u308b quick start \u3092\u30b3\u30d4\u30fc\u3057\u307e\u3057\u3087\u3046\u3002",
    "hero.hint.action": "agent \u3092\u9078\u629e",
    "hero.paste": "agent \u3054\u3068\u306e quick start",
    ...
    // Team memory spotlight
    "teamMemory.kicker": "チームメモリ",
    "teamMemory.heading": 'チーム全体で使う<span class="claw-accent">共有メモリレイヤー</span>',
    "teamMemory.desc": "ひとりが残した更新を、次の agent がすぐ使えます。",
    "teamMemory.stat1": "1つの共有メモリ層",
    "teamMemory.stat2": "cross-agent handoffs",
    "teamMemory.stat3": "再説明なし",
    "teamMemory.lane1.name": "Sarah · Claude Code",
    "teamMemory.lane1.note": "顧客アップデートを保存",
    "teamMemory.lane2.name": "Hazel · Codex",
    "teamMemory.lane2.note": "作業前に文脈を自動リコール",
    "teamMemory.core.title": "共有チームメモリ",
    "teamMemory.core.item1": "会議変更 → Thu 2pm",
    "teamMemory.core.item2": "提案の焦点 → sustainability",
    "teamMemory.core.item3": "source → Sarah",
    "teamMemory.recall.label": "next run",
    "teamMemory.recall.title": "チーム文脈はもう入っている",
    "teamMemory.recall.desc": "Slack を掘り返す必要も、背景を言い直す必要もありません。",
    "compare.row5.with": "\u4e00\u5ea6\u8aac\u660e\u3059\u308c\u3070\u3001\u305a\u3063\u3068\u8a18\u61b6",
    "compare.row6.label": "\u30c1\u30fc\u30e0\u30e1\u30e2\u30ea",
    "compare.row6.without": "\u77e5\u8b58\u304c\u500b\u5225\u306e\u30c1\u30e3\u30c3\u30c8\u306b\u9589\u3058\u8fbc\u3081\u3089\u308c\u308b",
    "compare.row6.with": "\u30e1\u30f3\u30d0\u30fc\u3068 agents \u304c\u540c\u3058\u5171\u6709\u30e1\u30e2\u30ea\u30ec\u30a4\u30e4\u30fc\u306e\u4e0a\u3067\u7a4d\u307f\u4e0a\u3052\u3089\u308c\u308b",
    "cta.title": '<span class="claw-accent">\u30bc\u30ed\u304b\u3089\u306e\u3084\u308a\u76f4\u3057</span>\u306f\u3082\u3046\u7d42\u308f\u308a\u3002',
    "cta.desc": "\u4f7f\u3063\u3066\u3044\u308b agent \u306e quick start \u3092\u30b3\u30d4\u30fc\u3057\u3066\u304f\u3060\u3055\u3044\u3002",
    "cta.paste": "agent \u30bb\u30c3\u30c8\u30a2\u30c3\u30d7\u30ac\u30a4\u30c9",
    "cta.note": "\u5404 tab \u3067\u305d\u306e agent \u5411\u3051\u306e\u30b3\u30d4\u30fc\u53ef\u80fd\u306a quick start \u3092\u63d0\u4f9b\u3057\u307e\u3059\u3002",
    ...
    "footer.features": "\u6a5f\u80fd",
    "footer.tagline": "OpenClaw\u3001Claude Code\u3001Codex\u3001Hermes \u3067\u5171\u6709\u3059\u308b\u8a18\u61b6\u30ec\u30a4\u30e4\u30fc\u3002",
