...
<img class="clawmem-diagram architecture-diagram" src="/images/docs/clawmem-architecture-real.svg" alt="ClawMem architecture: agent runtimes connect through plugins, skills, hooks, or MCP tools to ClawMem memory workflows, which use agent-git-service to store conversation issues, memory issues, wiki pages, labels, comments, search indexes, and permissions." />
